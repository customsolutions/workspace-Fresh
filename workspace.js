...
cprequire_test(["inline:com-chilipeppr-workspace-Fresh"], function(ws) {
    ...
    $('title').html("Fresh Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-Fresh", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-Fresh", // Make the id the same as the cpdefine id
        name: "Workspace / Fresh", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace Fresh.`,
        ...
        /**
         * Load the Template widget via chilipeppr.load() so folks have a Fresh
